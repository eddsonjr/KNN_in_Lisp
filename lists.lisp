...
;Criando uma proxima estrutura para testar a ordenacao de uma lista com base nessa estrutura
(defstruct test
	title
	class
	ratio
...
(setq testTemp (make-test
	:title "Testing 1"
	:class "A"
	:ratio 2.3
))

;dando append na lista
(setq myTestList(append myTestList(list testTemp)))
...
;referencias:
;;http://stackoverflow.com/questions/4606304/sorting-lists-according-to-some-elements
;;http://www.lispworks.com/documentation/HyperSpec/Body/f_sort_.htm
;;https://www.cs.cmu.edu/Groups/AI/html/cltl/clm/node146.html


(terpri)
(terpri)
(write "---------------Testing: Sorting a list of structs----------------")
(terpri)
(write "list-length: ")
(write (list-length myTestList))
(terpri)(terpri)
(write "List content: ") (terpri)
(write myTestList)
(terpri)

;tentando agora ordenar a lista de acordo com a chave ratio
(sort myTestList #'< :key #'test-ratio) ; ordenando do menor para o maior
(terpri)
;imprimindo a lista ordenada
(write "Lista ordenada [menor para maior]: ") (terpri)
(write myTestList)


(terpri)
(terpri)
(sort myTestList #'> :key #'test-ratio); ordenando do maior para o menor
(terpri)
;imprimindo a lista ordenada
(write "Lista ordenada [maior para menor]: ") (terpri)
(write myTestList)
